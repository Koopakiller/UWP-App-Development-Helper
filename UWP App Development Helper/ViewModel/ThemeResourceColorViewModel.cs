...
namespace Koopakiller.Apps.UwpAppDevelopmentHelper.ViewModel
{
    public class ThemeResourceColorViewModel : HeaderViewModelBase
    {
        ...
        {
            this.ThemeResources = new ObservableCollection<ColorViewModel>(new[]
                {
                ...
                }.Select(x => new ColorViewModel(x)));
        }

        public ObservableCollection<ColorViewModel> ThemeResources { get; }  
    }
